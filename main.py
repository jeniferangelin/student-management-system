...
curses = c.cursor()
curses.execute("CREATE TABLE IF NOT EXISTS student(ID INTEGER, NAME VARCHAR(30),AGE INTEGER ,DOB VARCHAR(30),GENDER VARCHAR(30),CITY VARCHAR(30))")
c.commit()
c.close()
print("table created")'''
class student:
...
# =================== BUTTONS =============================
        ...
        self.tree.insert("",index=0,value=(1,"Jenifer","10-12-2004",20,"female","chennai"))
        self.tree.pack()
